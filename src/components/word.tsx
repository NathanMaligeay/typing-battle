...
const Word: React.FC<WordProps> = ({ id, text, x, y, isHighlighted, onPositionUpdate, onReachBottom }) => {
    ...
    useEffect(() => {
        intervalRef.current = setInterval(() => {
            ...
            if (newY >= 780) {
                ...
                onReachBottom[0](id);
                if (isHighlighted) onReachBottom[1]();
            } else {
                yRef.current = newY;
    ...
    }, [id, isHighlighted, onPositionUpdate, onReachBottom[0], onReachBottom[1]]); // ### je suis pas sur de comprendre le useeffect ici, a chaque fois que y change (dc tt le temps),
